...
public class ReactingUserEdge extends com.zzw.github.graphql.schema.Metadata {
    @NonNull("!")
    ...
    private com.zzw.github.graphql.schema.scalars.DateTime reactedAt;
    public com.zzw.github.graphql.schema.scalars.DateTime getReactedAt() { return this.reactedAt; }
    public void setReactedAt(com.zzw.github.graphql.schema.scalars.DateTime reactedAt) { this.reactedAt = reactedAt; }
}
