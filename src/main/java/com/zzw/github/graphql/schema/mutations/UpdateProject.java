...
public class UpdateProject {
    @NonNull("!")
    private com.zzw.github.graphql.schema.inputobjects.UpdateProjectInput input;
    public com.zzw.github.graphql.schema.inputobjects.UpdateProjectInput getInput() { return this.input; }
    public void setInput(com.zzw.github.graphql.schema.inputobjects.UpdateProjectInput input) { this.input = input; }
