...
public class GpgSignature extends com.zzw.github.graphql.schema.Metadata implements com.zzw.github.graphql.schema.interfaces.GitSignature {
    @NonNull("!")
    ...
    private com.zzw.github.graphql.schema.scalars.String keyId;
    public com.zzw.github.graphql.schema.scalars.String getKeyId() { return this.keyId; }
    public void setKeyId(com.zzw.github.graphql.schema.scalars.String keyId) { this.keyId = keyId; }
