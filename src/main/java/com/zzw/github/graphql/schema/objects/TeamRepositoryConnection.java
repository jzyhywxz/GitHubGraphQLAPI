...
public class TeamRepositoryConnection extends com.zzw.github.graphql.schema.Metadata {
    @Description("A list of edges.")
    private com.zzw.github.graphql.schema.objects.TeamRepositoryEdge[] edges;
    public com.zzw.github.graphql.schema.objects.TeamRepositoryEdge[] getEdges() { return this.edges; }
    public void setEdges(com.zzw.github.graphql.schema.objects.TeamRepositoryEdge[] edges) { this.edges = edges; }
