...
@Description("Every GraphQL schema has a root type for both queries and mutations. The  defines GraphQL operations that retrieve data from the server.")
public class Query {
    @Arguments({
        ...
        @Argument(name="organizationId", type="com.zzw.github.graphql.schema.scalars.ID", nonNull=@NonNull(""), description=@Description("Returns the last")),
        @Argument(name="primaryCategoryOnly", type="com.zzw.github.graphql.schema.scalars.Boolean", nonNull=@NonNull(""), description=@Description("elements from the list.")),
        @Argument(name="slugs", type="com.zzw.github.graphql.schema.scalars.String[]", nonNull=@NonNull(""), description=@Description("Select listings for products owned by the specified organization.")),
        @Argument(name="useTopicAliases", type="com.zzw.github.graphql.schema.scalars.Boolean", nonNull=@NonNull(""), description=@Description("Select only listings where the primary category matches the given category slug.")),
        @Argument(name="viewerCanAdmin", type="com.zzw.github.graphql.schema.scalars.Boolean", nonNull=@NonNull(""), description=@Description("The default value is")),
        @Argument(name="withFreeTrialsOnly", type="com.zzw.github.graphql.schema.scalars.Boolean", nonNull=@NonNull(""), description=@Description(".")),
    })
    @NonNull("!")
    ...
    @Arguments({
        ...
        @Argument(name="type", type="com.zzw.github.graphql.schema.enums.SearchType", nonNull=@NonNull("!"), description=@Description("elements from the list.")),
    })
    @NonNull("!")
    ...
    @NonNull("!")
    @Description("Hack to workaround ")
    private com.zzw.github.graphql.schema.query.Query relay;
    public com.zzw.github.graphql.schema.query.Query getRelay() { return this.relay; }
    public void setRelay(com.zzw.github.graphql.schema.query.Query relay) { this.relay = relay; }
