...
public class TeamMemberConnection extends com.zzw.github.graphql.schema.Metadata {
    @Description("A list of edges.")
    private com.zzw.github.graphql.schema.objects.TeamMemberEdge[] edges;
    public com.zzw.github.graphql.schema.objects.TeamMemberEdge[] getEdges() { return this.edges; }
    public void setEdges(com.zzw.github.graphql.schema.objects.TeamMemberEdge[] edges) { this.edges = edges; }
