...
public class IssueTimelineItemsConnection extends com.zzw.github.graphql.schema.Metadata {
    @Description("A list of edges.")
    private com.zzw.github.graphql.schema.objects.IssueTimelineItemsEdge[] edges;
    public com.zzw.github.graphql.schema.objects.IssueTimelineItemsEdge[] getEdges() { return this.edges; }
    public void setEdges(com.zzw.github.graphql.schema.objects.IssueTimelineItemsEdge[] edges) { this.edges = edges; }
    ...
    private com.zzw.github.graphql.schema.unions.IssueTimelineItems[] nodes;
    public com.zzw.github.graphql.schema.unions.IssueTimelineItems[] getNodes() { return this.nodes; }
    public void setNodes(com.zzw.github.graphql.schema.unions.IssueTimelineItems[] nodes) { this.nodes = nodes; }
