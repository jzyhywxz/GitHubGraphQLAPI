...
public class UnresolveReviewThread {
    @NonNull("!")
    private com.zzw.github.graphql.schema.inputobjects.UnresolveReviewThreadInput input;
    public com.zzw.github.graphql.schema.inputobjects.UnresolveReviewThreadInput getInput() { return this.input; }
    public void setInput(com.zzw.github.graphql.schema.inputobjects.UnresolveReviewThreadInput input) { this.input = input; }
