...
public class RepositoryCollaboratorConnection extends com.zzw.github.graphql.schema.Metadata {
    @Description("A list of edges.")
    private com.zzw.github.graphql.schema.objects.RepositoryCollaboratorEdge[] edges;
    public com.zzw.github.graphql.schema.objects.RepositoryCollaboratorEdge[] getEdges() { return this.edges; }
    public void setEdges(com.zzw.github.graphql.schema.objects.RepositoryCollaboratorEdge[] edges) { this.edges = edges; }
