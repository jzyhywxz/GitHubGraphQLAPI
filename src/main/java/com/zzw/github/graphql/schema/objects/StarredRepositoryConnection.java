...
public class StarredRepositoryConnection extends com.zzw.github.graphql.schema.Metadata {
    @Description("A list of edges.")
    private com.zzw.github.graphql.schema.objects.StarredRepositoryEdge[] edges;
    public com.zzw.github.graphql.schema.objects.StarredRepositoryEdge[] getEdges() { return this.edges; }
    public void setEdges(com.zzw.github.graphql.schema.objects.StarredRepositoryEdge[] edges) { this.edges = edges; }
