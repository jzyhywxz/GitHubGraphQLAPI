...
public class StargazerConnection extends com.zzw.github.graphql.schema.Metadata {
    @Description("A list of edges.")
    private com.zzw.github.graphql.schema.objects.StargazerEdge[] edges;
    public com.zzw.github.graphql.schema.objects.StargazerEdge[] getEdges() { return this.edges; }
    public void setEdges(com.zzw.github.graphql.schema.objects.StargazerEdge[] edges) { this.edges = edges; }
