...
public class UpdateCheckSuitePreferences {
    @NonNull("!")
    private com.zzw.github.graphql.schema.inputobjects.UpdateCheckSuitePreferencesInput input;
    public com.zzw.github.graphql.schema.inputobjects.UpdateCheckSuitePreferencesInput getInput() { return this.input; }
    public void setInput(com.zzw.github.graphql.schema.inputobjects.UpdateCheckSuitePreferencesInput input) { this.input = input; }
