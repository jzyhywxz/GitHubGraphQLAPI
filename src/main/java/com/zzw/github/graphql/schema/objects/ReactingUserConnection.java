...
public class ReactingUserConnection extends com.zzw.github.graphql.schema.Metadata {
    @Description("A list of edges.")
    private com.zzw.github.graphql.schema.objects.ReactingUserEdge[] edges;
    public com.zzw.github.graphql.schema.objects.ReactingUserEdge[] getEdges() { return this.edges; }
    public void setEdges(com.zzw.github.graphql.schema.objects.ReactingUserEdge[] edges) { this.edges = edges; }
