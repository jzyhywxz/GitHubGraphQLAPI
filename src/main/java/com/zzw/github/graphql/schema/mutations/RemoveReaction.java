...
public class RemoveReaction {
    @NonNull("!")
    private com.zzw.github.graphql.schema.inputobjects.RemoveReactionInput input;
    public com.zzw.github.graphql.schema.inputobjects.RemoveReactionInput getInput() { return this.input; }
    public void setInput(com.zzw.github.graphql.schema.inputobjects.RemoveReactionInput input) { this.input = input; }
