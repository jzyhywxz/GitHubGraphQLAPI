...
public class ReleaseConnection extends com.zzw.github.graphql.schema.Metadata {
    @Description("A list of edges.")
    private com.zzw.github.graphql.schema.objects.ReleaseEdge[] edges;
    public com.zzw.github.graphql.schema.objects.ReleaseEdge[] getEdges() { return this.edges; }
    public void setEdges(com.zzw.github.graphql.schema.objects.ReleaseEdge[] edges) { this.edges = edges; }

    @Description("A list of nodes.")
    private com.zzw.github.graphql.schema.objects.Release[] nodes;
    public com.zzw.github.graphql.schema.objects.Release[] getNodes() { return this.nodes; }
    public void setNodes(com.zzw.github.graphql.schema.objects.Release[] nodes) { this.nodes = nodes; }
