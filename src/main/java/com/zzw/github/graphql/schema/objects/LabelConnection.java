...
public class LabelConnection extends com.zzw.github.graphql.schema.Metadata {
    @Description("A list of edges.")
    private com.zzw.github.graphql.schema.objects.LabelEdge[] edges;
    public com.zzw.github.graphql.schema.objects.LabelEdge[] getEdges() { return this.edges; }
    public void setEdges(com.zzw.github.graphql.schema.objects.LabelEdge[] edges) { this.edges = edges; }

    @Description("A list of nodes.")
    private com.zzw.github.graphql.schema.objects.Label[] nodes;
    public com.zzw.github.graphql.schema.objects.Label[] getNodes() { return this.nodes; }
    public void setNodes(com.zzw.github.graphql.schema.objects.Label[] nodes) { this.nodes = nodes; }
