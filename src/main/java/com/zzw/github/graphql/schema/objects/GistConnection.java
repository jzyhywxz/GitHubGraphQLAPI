...
public class GistConnection extends com.zzw.github.graphql.schema.Metadata {
    @Description("A list of edges.")
    private com.zzw.github.graphql.schema.objects.GistEdge[] edges;
    public com.zzw.github.graphql.schema.objects.GistEdge[] getEdges() { return this.edges; }
    public void setEdges(com.zzw.github.graphql.schema.objects.GistEdge[] edges) { this.edges = edges; }

    @Description("A list of nodes.")
    private com.zzw.github.graphql.schema.objects.Gist[] nodes;
    public com.zzw.github.graphql.schema.objects.Gist[] getNodes() { return this.nodes; }
    public void setNodes(com.zzw.github.graphql.schema.objects.Gist[] nodes) { this.nodes = nodes; }
