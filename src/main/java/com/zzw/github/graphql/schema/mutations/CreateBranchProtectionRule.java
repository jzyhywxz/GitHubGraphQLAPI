...
public class CreateBranchProtectionRule {
    @NonNull("!")
    private com.zzw.github.graphql.schema.inputobjects.CreateBranchProtectionRuleInput input;
    public com.zzw.github.graphql.schema.inputobjects.CreateBranchProtectionRuleInput getInput() { return this.input; }
    public void setInput(com.zzw.github.graphql.schema.inputobjects.CreateBranchProtectionRuleInput input) { this.input = input; }
